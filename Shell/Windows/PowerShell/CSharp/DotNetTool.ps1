function Invoke-ProjectPack {
    ...
    .EXAMPLE
        ...
        Invoke-ProjectPack -ProjectFullPaths $ProjectsToPack -TargetFolder $TargetDir
...
function Publish-NuGetPackage {
    ...
    .EXAMPLE
        Publish-NuGetPackage -PackagePath ".\bin\Release\MyPackage.1.0.0.nupkg" -Source "https://nuget.pkg.github.com/seanhocode/index.json" -ApiKey "ghp_xxxxxxxxxxxx" -SkipDuplicate

    .EXAMPLE
        Publish-NuGetPackage -PackagePath "*.nupkg" -Source "nuget.org" -ApiKey "oy2a..." -Timeout 600 -NoServiceEndpoint
